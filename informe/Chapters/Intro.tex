...
Es interesantes marcar que la raiz que usemos para agrupar, no tiene porque ser necesariamente una palabra. Esto es util porque en la práctica permite simplificar los algoritmos de stemming. \cite{word_stemming}
